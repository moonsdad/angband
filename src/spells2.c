...
void starlite(register int y, register int x)
{
    register int i;
...
void starball(register int y, register int x)
{
    register int        i;
...
{
    register monster_race *c_ptr = &r_list[m_list[mnum].mptr];
    int y, x;
    int i,j,k;
